import { User, MapPin, Radio, Navigation, Clock, ArrowRight } from "lucide-react";
...
const BottomStrip = () => {
  return (
    <div className="mc-panel flex flex-shrink-0 h-44">
      {/* Responders */}
      <div className="w-[45%] flex flex-col border-r border-mc-panel-border">
