...
const OpsCenter = () => {
  const { cameras, alerts: liveAlerts, addCamera, removeCamera, reanalyzeCamera } = useCameras();
      ...
      <div className="flex-1 flex min-h-0">
        ...
        {!focusMode && (
          <div className="w-[220px] flex-shrink-0 border-r border-mc-panel-border">
            <CameraPanel cameras={cameras} onAddCamera={addCamera} onRemoveCamera={removeCamera} onReanalyze={reanalyzeCamera} />
          </div>
        )}
